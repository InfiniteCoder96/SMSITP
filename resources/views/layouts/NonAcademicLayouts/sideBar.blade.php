    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="p-t-30">
                ...
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Other Events</span></a>
                    <ul aria-expanded="false" class="collapse  first-level">
                        <li class="sidebar-item"><a href="{{url('/NAadmin/event-calender')}}" class="sidebar-link"><i class="mdi mdi-human-male-female"></i><span class="hide-menu"> Event Calender </span></a></li>
                        <li class="sidebar-item"><a href="{{url('/NAadmin/event-budget')}}" class="sidebar-link"><i class="mdi mdi-human-male-female"></i><span class="hide-menu"> Budget </span></a></li>
                        <li class="sidebar-item"><a href="{{url('/NAadmin/event-approvals')}}" class="sidebar-link"><i class="mdi mdi-human-male-female"></i><span class="hide-menu"> Approvals </span></a></li>
                    </ul>
                </li>
