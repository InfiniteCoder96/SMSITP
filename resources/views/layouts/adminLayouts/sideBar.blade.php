                ...
                <ul id="sidebarnav" class="p-t-30 " >
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-clipboard-account"></i><span class="hide-menu">Manage Students</span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item"><a href="{{url('/admin/manage-students')}}" class="sidebar-link"><i class="mdi mdi-human-child"></i><span class="hide-menu"> All Students </span></a></li>
                            <li class="sidebar-item"><a href="{{url('/admin/manage-teacher')}}" class="sidebar-link"><i class="mdi mdi-details"></i><span class="hide-menu"> Student Details </span></a></li>
                            <li class="sidebar-item"><a href="{{url('/admin/manage-parents')}}" class="sidebar-link"><i class="mdi mdi-account-plus"></i><span class="hide-menu"> Entroll New Student </span></a></li>
