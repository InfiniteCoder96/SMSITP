        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav" >
                <ul id="sidebarnav" class="p-t-30 " >
                    ...
                    <li class="sidebar-item active"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('new-admissions')}}" aria-expanded="false"><i class="mdi mdi-account-alert"></i><span class="hide-menu">New Admissions</span></a></li>
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-clipboard-account"></i><span class="hide-menu">Manage Students</span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            ...
                            <li class="sidebar-item"><a href="{{url('search')}}" class="sidebar-link"><i class="mdi mdi-details"></i><span class="hide-menu"> Search Students </span></a></li>


                        </ul>
                    </li>
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-account-convert"></i><span class="hide-menu">Manage Teachers</span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item"><a href="{{url('/admin/manage-students')}}" class="sidebar-link"><i class="mdi mdi-human-male-female"></i><span class="hide-menu"> All Teachers </span></a></li>
                            <li class="sidebar-item"><a href="{{url('/admin/manage-teacher')}}" class="sidebar-link"><i class="mdi mdi-human-female"></i><span class="hide-menu"> Teacher Details </span></a></li>
                ...
                <ul id="sidebarnav" class="p-t-30 " >
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-clipboard-account"></i><span class="hide-menu">Manage Students</span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item"><a href="{{url('/students/create')}}" class="sidebar-link"><i class="mdi mdi-account-plus"></i><span class="hide-menu"> Entroll New Student </span></a></li>
                            <li class="sidebar-item"><a href="{{url('/students')}}" class="sidebar-link"><i class="mdi mdi-human-child"></i><span class="hide-menu"> All Students </span></a></li>
                            <li class="sidebar-item"><a href="{{url('student_search')}}" class="sidebar-link"><i class="mdi mdi-details"></i><span class="hide-menu"> Search Students </span></a></li>
