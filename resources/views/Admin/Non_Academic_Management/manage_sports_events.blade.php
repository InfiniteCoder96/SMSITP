                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card bg-secondary text-white">
                            <div class="card-header bg-info text-white">
                                <div class="row">
                                    <div class="col-sm-2">
                                        <h5 class="card-title m-b-0">Sport Events Details</h5>
                                    </div>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <div class="col-sm-3">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table">
                                   ...
                                   <tr>
                                        ...
                                        <th scope="col" style="font-size: 12px">Sports Event ID</th>
                                        <th scope="col" style="font-size: 12px">Sport Event Name</th>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 12px">Time&venue - 15th september at torinton ground</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 12px">Foot Ball</td>
                                        <td style="font-size: 12px">A</td>
                                        <td style="font-size: 12px">Time&venue - 12th september at colombo university ground</td>
                                        <td style="font-size: 12px">
