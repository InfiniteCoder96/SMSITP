                                ...
                                <div class="card-block pt-2 pb-0">
                                    <div class="media">
                                        <div class="media-body white text-left">
                                            <h3 class="font-large-1 mb-0">{{$profit}}</h3>
                                            <span>Profit</span>
                                        </div>
                        ...
                        <div class="card gradient-pomegranate">
                            <div class="card-body">
                                <div class="card-block pt-2 pb-0">
                                    <div class="media">
                                        <div class="media-body white text-left">
                                            <h3 class="font-large-1 mb-0">{{$Tot}}</h3>
                        ...
                        <div class="card gradient-pomegranate">
                            <div class="card-body" style="height: 50px">
                                <div class="card-block pt-0 pb-0">
                                    <div class="media">
                                        <div class="media-body white text-left">
                                            <h3 class="font-large-1 mb-0" center="10px"></h3>
                                            <span> <a href=" {{url('/final/Report')}}"</a>Download Report</span>
                                        </div>
                                        {{--<div class="media-right white text-right">--}}
                                            {{--<i class="icon-wallet font-large-1"></i>--}}
                                        {{--</div>--}}
