                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="card text-white bg-dark mb-3 card-hover" style="height: 160px">
                                        <div class="row">
                                            <div class="col-md-4 card-body bg-orange">
                                                <center><i class="fa-7x far fa fa-table m-b-5"></i></center>
                                                <center><h5 class="card-title">Total Books</h5></center>
                                            </div>
                                            <div class="card-body"><br>
                                                <center><h5 style="font-size:40px;vertical-align: bottom" class="card-title timer" data-from="0" data-to="50" data-speed="2000" data-fresh-interval="20">Rs.500,0000</h5></center>
                                    ...
                                    <div class="card text-white bg-dark mb-3 card-hover" style="height: 160px">
                                        <div class="row">
                                            <div class="col-md-4 card-body bg-success">
                                                <center><i class="fa-7x far mdi mdi-message-alert"></i></center>
                                                <center><h5 class="card-title">Issued Books</h5></center>
                                            </div>
                                            <div class="card-body"><br>
                                                <center><h5 style="font-size:40px;vertical-align: bottom" class="card-title timer" data-from="0" data-to="70" data-speed="20" data-fresh-interval="20">Rs.500,0000</h5></center>
                                    ...
                                    <div class="card text-white bg-dark mb-3 card-hover" style="height: 160px">
                                        <div class="row">
                                            <div class="col-md-4 card-body bg-purple">
                                                <center><i class="fa-8x far mdi mdi-account-plus"></i></center>
                                                <center><h5 class="card-title">Total Users</h5></center>
                                            </div>
                                            <div class="card-body"><br>
                                                <center><h5 style="font-size:40px;vertical-align: bottom" class="card-title timer" data-from="0" data-to="100" data-speed="2000" data-fresh-interval="20"></h5></center>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="card text-white bg-dark mb-3 card-hover" style="height: 150px">
                                        <div class="row">
                                            ...
                                            <div class="card-body"><br>
                                                <center><h5 style="font-size:40px;vertical-align: bottom" class="card-title timer" data-from="0" data-to="56" data-speed="2000" data-fresh-interval="20">Rs.500,0000</h5></center>
                                ...
                                <div class="col-md-4">
                                    <div class="card text-white bg-dark mb-3 card-hover" style="height: 100px">
                                        <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="card text-white bg-dark mb-3 card-hover" style="height: 100px">
                                        <div class="row">
                                            ...
                                            <div class="card-body"><br>
                                                <center><h6 style="font-size:40px;vertical-align: bottom" class="card-title timer" data-from="0" data-to="80" data-speed="2000" data-fresh-interval="20">Rs.500,0000</h6></center>
