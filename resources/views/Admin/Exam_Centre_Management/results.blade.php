                    ...
                    <form method="get" action="{{url('results/create')}} ">
                        ...
                        <div class="card bg-dark text-white">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="sId" class="form-control" id="sId" placeholder="Student ID Name Here" value="{{old('sId')}}" >
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <select class="select2 form-control custom-select" style="width: 100%; height:36px;" name="grade" >
