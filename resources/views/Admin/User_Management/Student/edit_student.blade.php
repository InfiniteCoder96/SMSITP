...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Students Management Portal</h4>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title m-b-0">Main Controls</h5>
                <button class="btn  btn-outline-success btn-lg"><i class="mdi mdi-account-plus font-40"></i></button>&nbsp;&nbsp;&nbsp;&nbsp;
                <button class="btn  btn-outline-cyan btn-lg"><i class="mdi mdi-account-remove font-40"></i></button>&nbsp;&nbsp;&nbsp;&nbsp;
                <button class="btn  btn-outline-orange btn-lg"><i class="mdi mdi-account-settings-variant font-40"></i></button>&nbsp;&nbsp;&nbsp;&nbsp;
                <button class="btn  btn-outline-dark btn-lg"><i class="mdi mdi-contact-mail font-40"></i></button>
            </div>
